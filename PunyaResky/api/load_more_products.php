...
/**
 * ================================================
 * API: LOAD MORE PRODUCTS - SUPERMARKET BUAH E-COMMERCE
 * ================================================
 * File: api/load_more_products.php
 * Description: API endpoint untuk memuat produk tambahan
 *              dengan pagination, search, dan filter
 * Returns: HTML cards + total count as JSON
 * Layout: sesuai dengan product card minimalis terbaru (tanpa emoji)
 * ================================================
 */
...
// Build HTML (minimalis, tanpa emoji, tanpa origin/deskripsi, sesuai catalog.php terbaru)
ob_start();
