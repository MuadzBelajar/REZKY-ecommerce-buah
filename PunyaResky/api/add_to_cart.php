...
/**
 * ================================================
 * API: Add to Cart - SUPERMARKET BUAH E-COMMERCE
 * ================================================
 * File: api/add_to_cart.php
 * Description: API endpoint untuk menambahkan produk
 *              ke keranjang belanja (session-based)
 * ================================================
 */
