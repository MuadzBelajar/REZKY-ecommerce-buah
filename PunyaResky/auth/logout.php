...
/**
 * ================================================
 * LOGOUT HANDLER - SUPERMARKET BUAH E-COMMERCE
 * ================================================
...
<head>
    ...
    <title>Logout - Supermarket Buah</title>
    <link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;600&display=swap" rel="stylesheet">
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { 
            font-family: 'DM Sans', sans-serif; 
            background: linear-gradient(135deg, #F5FBE6 0%, #E8F5D6 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<body>
    <div class="logout-card">
        ...
        <p class="logout-message">
            Terima kasih telah menggunakan Supermarket Buah.<br>
